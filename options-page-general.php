...
if(! function_exists('is_ecae_premium_exist'))
{
	...
	printf(__('Purchase the %1$s Premium Edition %2$s to enable all display image options below',TONJOO_ECAE),"<a href='https://tonjoo.com/addons/easy-custom-auto-excerpt-premium' target='_blank'>","</a>");
	echo "</h3></td></tr>";
}
